    ...
    return (
        <section id="home" aria-labelledby="hero-heading" className="relative overflow-hidden bg-white">
            ...
            <div className="absolute inset-0 -z-10">
                {/* radial glows */}
                <div className="pointer-events-none absolute -top-40 -right-32 h-[28rem] w-[28rem] rounded-full bg-emerald-300/20 blur-3xl" />
                <div className="pointer-events-none absolute -bottom-40 -left-32 h-[26rem] w-[26rem] rounded-full bg-teal-300/20 blur-3xl" />
                {/* subtle grid overlay */}
                <div className="absolute inset-0 opacity-[0.08] [background-image:linear-gradient(to_right,#000_1px,transparent_1px),linear-gradient(to_bottom,#000_1px,transparent_1px)] [background-size:60px_60px]" />
                {/* gradient vignette */}
            ...
            >
                <div className="grid items-center gap-20 md:grid-cols-2"> {/* Increased gap */}
                        ...
                        <motion.div variants={itemVariants} className="mb-7 flex flex-wrap items-center gap-3">
                            {badges.map((b, i) => (
                                <motion.span
                                    ...
                                    className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200/60 bg-white/60 px-3 py-1 text-xs font-medium text-emerald-700 backdrop-blur-sm shadow-sm hover:bg-white/80"
                                >
                    ...
                    <motion.div variants={imageVariants} className="relative h-80 md:h-[520px] will-change-transform">
                        {/* layered card */}
                        <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-emerald-100/40 via-white to-teal-100/40 blur-xl" />
                        <div className="relative h-full w-full overflow-hidden rounded-2xl border border-slate-200/50 bg-white/40 backdrop-blur-sm shadow-2xl">
                            <Image
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-4 left-4 right-4 flex items-center gap-3 rounded-xl bg-white/70 px-4 py-3 backdrop-blur-md shadow-md"
                            >
                            ...
                            <motion.span
                                className="absolute top-6 left-6 hidden md:flex h-10 w-10 items-center justify-center rounded-full bg-white/70 backdrop-blur-sm shadow border border-emerald-200 text-emerald-600"
                            ...
                            <motion.span
                                className="absolute top-10 right-8 hidden md:flex h-12 w-12 items-center justify-center rounded-2xl bg-white/70 backdrop-blur-sm shadow border border-teal-200 text-teal-600"
                            ...
                            <motion.span
                                className="absolute bottom-28 -left-2 hidden md:flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 text-white shadow-lg"
