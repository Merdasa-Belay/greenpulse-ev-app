      ...
      <div className="bg-white p-8 w-[450px] rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/forgot-password" className="text-blue-500 font-medium hover:text-blue-700 transition">
              Forgot password?
            </Link>
          </div>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full border border-gray-200 rounded-lg h-12 flex items-center justify-center gap-3 bg-white hover:border-blue-500 transition"
